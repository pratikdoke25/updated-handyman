...
export const Services = () => {
  const servicesInfo = [{
    ...
    icon: <MdOutlineCleaningServices size={48} className='service-icon'/>  // Increased size for better visibility
  }, {
    ...
    icon: <MdOutlineWindow size={48} className='service-icon'/>  // Increased size
  }, {
    title: <h2>Pressure <br/> Wash</h2>,
    description: "Clean and restore your property's exterior, removing dirt, grime, and stains.",
    icon: <MdOutlineWaterDrop size={48} className='service-icon'/>  // Increased size
  }, {
    ...
    icon: <MdOutlineFormatPaint size={48} className='service-icon'/>  // Increased size
  }, {
    ...
    icon: <MdOutlinePlumbing size={48} className='service-icon'/>  // Increased size
  }, {
    title: <h2>Basic <br/> Electrical</h2>,
    description: "Our skilled technicians ensure your home remains safe and functional.",
    icon: <MdOutlineElectricalServices size={48} className='service-icon'/>  // Increased size
  }, {
    title: <h2>Drywall <br/> Patch</h2>,
    description: "We specialize in repairing holes, dents, and imperfections in drywall.",
    icon: <MdOutlineHomeRepairService size={48} className='service-icon'/>  // Increased size
  }, {
    ...
    icon: <IoHammerOutline size={48} className='service-icon'/>  // Increased size
  }]
